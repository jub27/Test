...
3.BaseEffect1.cs -- Special effects base class, which encapsulates some basic interfaces.
4.Bullet1.cs -- The bullet base class encapsulates the basic interface of the bullet and is also the basic implementation of the linear linear bullet.
...
7.MathUtil1.cs -- General mathematical calculation formula.
