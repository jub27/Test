...
#define WINDOW_W		500
#define WINDOW_H		500
#define WINDOW_TITLE	L"HeightMap+Camera+Frustum"
...
BOOL					g_bHideFrustum = FALSE;	// Frustum을 안그릴 것인가?
...
INT WINAPI WinMain(HINSTANCE hInst, HINSTANCE, LPSTR, INT)
{
	...
	// 윈도우 생성
	HWND hWnd = CreateWindow(L"D3D Frustum", WINDOW_TITLE,
	...
	delete g_pLog;
	delete g_pCamera;
	UnregisterClass(L"D3D Frustum", wc.hInstance);
	return 0;
}
