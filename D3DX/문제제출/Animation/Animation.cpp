...
void Animate()
{
	...
	//회전값의 구면 선형 보간
	D3DXQuaternionSlerp(&quat, &g_aniRot[0], &g_aniRot[1], rot_t);
	//사원수를 회전 행렬값으로 변환
...
void Render()
{
	...
	g_Font->DrawText(NULL, "TEST", -1, &g_Rect, DT_NOCLIP, D3DXCOLOR(1.0f, 1.0f, 0.0f, 1.0f));
