...
public:
	 ...
	 */
	HRESULT		Create( LPDIRECT3DDEVICE9 pDev, D3DXVECTOR3* pvfScale, float fLODRatio, const char* lpBMPFilename, LPCWSTR lpTexFilename[MAX_TERRAIN_TEX] );
...
private:
	...
	HRESULT		_LoadTextures(LPCWSTR lpTexFilename[MAX_TERRAIN_TEX] );
